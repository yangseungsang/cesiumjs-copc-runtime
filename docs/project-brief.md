...
> **출처 및 라이선스 범위:** 이 문서는
> [Gaia3D OSSP 2026 공식 과제 페이지](https://www.kossa.kr/materials/2026/ossp/tasks-gaia3d.html)를
> 요약하고 일부 짧은 문구를 인용합니다. 저장소의 MIT License는 프로젝트 작성자가
> 추가한 분석·설계·구현 현황에만 적용되며, 인용문과 원 과제 페이지의 제3자 자료를
> MIT로 재라이선스하지 않습니다. 자세한 내용은
